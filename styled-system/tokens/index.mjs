const tokens = {
  ...
  "fontSizes.hero": {
    "value": "clamp(28px, 4vw, 46px)",
    "variable": "var(--font-sizes-hero)"
  },
  "colors.current": {
    "value": "currentColor",
  ...
  "shadows.card": {
    "value": "0 18px 40px rgba(99, 62, 28, 0.12)",
  ...
  "sizes.copyWidth": {
    "value": "520px",
    "variable": "var(--sizes-copy-width)"
  },
  "sizes.modalWidth": {
    "value": "420px",
    "variable": "var(--sizes-modal-width)"
  },
  "sizes.searchMin": {
    "value": "220px",
    "variable": "var(--sizes-search-min)"
  },
  "sizes.thumb": {
    "value": "80px",
    "variable": "var(--sizes-thumb)"
  },
  "sizes.px1": {
    "value": "1px",
    "variable": "var(--sizes-px1)"
  },
  "sizes.breakpoint-sm": {
    "value": "640px",
